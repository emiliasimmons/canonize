...
1. **Read the taxonomy block** at the top of `<root>/index.md` (a few hundred tokens): the topics with their one-line descriptions and member counts, and the tag vocabulary.
